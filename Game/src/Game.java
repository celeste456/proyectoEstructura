...
public class Game extends JPanel {
    ...
    private Rectangle rectangulo1, rectangulo2, rectangulo3, rectangulo4, rectangulo5, rectangulo6;
    private Point puntoInicial1, puntoInicial2, puntoInicial3, puntoInicial4, puntoInicial5;
    ...
    public Game(){
        ...
        this.imagen6 = new ImageIcon(getClass().getResource("hambSencilla.png"));
        ...
        this.rectangulo6 = new Rectangle(230, 225, 100, 85);
        puntajeLabel = new JLabel("Puntaje: 0");
        this.add(puntajeLabel); // Agrega el JLabel al panel
        setLayout(new BorderLayout());
        add(puntajeLabel, BorderLayout.SOUTH);//coloca el JLabel abajo del panel
    ...
    public void movimientos() {
        MouseAdapter ma = new MouseAdapter() {
            boolean movimiento1 = false;boolean movimiento2 = false;boolean movimiento3 = false;boolean movimiento4 = false;boolean movimiento5 = false;
            int distanciaX1, distanciaY1;
       ...
       if(colisionado!=null){
            ...
            case 5:
                if(!seleccionados.contains(1)){
                    ...
                    this.imagen6 = new ImageIcon(getClass().getResource("hambQueso.png"));
                }
                break;
            case 10:
                 if(!seleccionados.contains(1)){
                    ...
                    puntaje=puntaje+10;
                    puntajeLabel.setText("Puntaje: " + puntaje);
                    this.imagen6 = new ImageIcon(getClass().getResource("hambEspecial.png"));
                }
                 break;
            case 15:
                if(!seleccionados.contains(1)){
